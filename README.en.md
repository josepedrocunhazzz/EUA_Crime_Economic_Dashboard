...
Developed by **José Cunha and Marta Antunes** for the Advanced Data Visualisation course. See the [final report](VAD_Final_Report.pdf) for the rationale, prototypes, data processing and complete discussion.
